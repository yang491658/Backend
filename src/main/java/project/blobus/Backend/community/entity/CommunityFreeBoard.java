...
public class CommunityFreeBoard extends Post {
    public CommunityFreeBoard(Long id, String title, String content, String authorId, BoardType boardType, UserType userType, LocalDateTime createdAt, LocalDateTime updateAt, List<CommunityComment> comments) {
