...
import project.blobus.Backend.temp.entity.YouthStartupPolicy;
import project.blobus.Backend.temp.repository.YouthStartupPolicyRepository;
...
@SpringBootTest
class YouthStartupPolicyRepositoryTest {
    @Autowired
