...
class CommunityServiceTest {
    ...
    public void test1() {
        PageRequestDTO pageRequestDTO = PageRequestDTO.builder()
                ...
                .size(10)
                .build();
        PageResponseDTO<CommnuntiyDTO> result = service.getList(pageRequestDTO, "", "", "");
    ...
    public void test2() {
        Long id = 1L;
        CommnuntiyDTO dto = service.get(id);
    ...
    public void test3() {
        ...
        for (int i = 1; i <= 3; i++) {
            CommnuntiyDTO dto = CommnuntiyDTO.builder()
                    .boadrType(i == 3 ? "건의" : "자유")
