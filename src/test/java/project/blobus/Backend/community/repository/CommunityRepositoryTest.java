    ...
    public void test() {
        ...
        for (int i = 1; i <= max; i++) {
            ...
            Community community = Community.builder()
                    .boadrType(random.nextInt(2) == 0 ? "자유" : "건의")
                    .category(categoryList[random.nextInt(3)])
                    .title("임시 제목 " + i)
                    ...
                    .author("테스트" + authorNum)
                    .authorId("test" + authorNum + "@test.com")
                    .createdAt(dateTime)
                    .updatedAt(dateTime.plusDays(random.nextInt(max + 1 - i)))
                    .build();

            if (community.getBoadrType() == "건의") community.setVisibility(random.nextInt(2) == 0);
